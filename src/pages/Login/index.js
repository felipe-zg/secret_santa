...
import { Container, Formulario, Botao, Input, Banner, Texto, Link, Footer } from './styles';
...
export default function Login({navigation}) {
    ...
    return (
        <Container>
            ...
            <Formulario>
                <Input placeholder="Digite seu E-mail" value={email} 
                        returnKeyType="next" 
                        onSubmitEditing={() => {focusField('field2') }}
                        blurOnSubmit={false}
                        onChangeText={email=>setEmail(email)} />
                <Input placeholder= "Digite sus Senha" value={password} 
