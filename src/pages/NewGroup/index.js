  ...
  return (
    <Container>
      <FormularioNovoGrupo>
        ...
        <Input
          value={nomeDoGrupo}
          onChangeText={nome => setNomeDoGrupo(nome)}
        />
        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
          {emojis.map(emoji => (
            <TouchableOpacity
              ...
              style={
                emoji.selected ? styles.viewEmojiSelecionado : styles.viewEmoji
              }>
        ...
        <Participantes
          ...
          renderItem={({item}) => (
            <Participante>
              ...
              <TouchableOpacity
                style={styles.trash}
                onPress={() => DeletaParticipante(item.id)}>
